...
class pascal_voc(object):
    ...
    def get(self):
        ...
        labels = np.zeros((self.batch_size, self.cell_size, self.cell_size, 5 + len(self.classes)))
        count = 0
